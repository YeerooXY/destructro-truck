# Destructro Truck AI Start Here
...
When intake is incomplete, read `assembly/prompts/00-intake-interviewer.md` and ask exactly one high-impact question per turn. Do not output a complete MVP, game loop, feature inventory, stack, architecture, repository layout, or tasks. Stop immediately after the one question.
